...
namespace RayKeys.UI {
    public class ClickButton {
        ...
        public ClickButton(Align h, Align v, string id, string text, int x, int y, int sizeX = 600, int sizeY = 200, int fontSize = 2, bool drawFrame = true) {
        ...
        private void Draw(float delta) {
            ...
            if (drawFrame)
                RRender.Draw(Align.None, Align.None, Textures.Button, X, Y, sizeX, sizeY, cColour);
